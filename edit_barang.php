...
if (isset($_POST['submit']))
{
	...
	$sql = mysql_query("UPDATE user SET id='$id', nama='$nama', kategori='$kategori' , harga_jual='$harga_jual', harga_beli='$harga_beli', stok='$stok', file_gambar='$file_gambar' WHERE id='$id'");
